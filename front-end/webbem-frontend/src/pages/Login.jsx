  ...
  return (
    <div className="min-h-screen w-full flex bg-gray-50 lg:bg-[#0B1120] font-sans overflow-hidden relative">
      ...
      <div className="absolute top-0 left-0 w-full h-[50vh] lg:hidden z-0 overflow-hidden">
         ...
         />
         <div className="absolute inset-0 bg-gradient-to-b from-blue-950/80 via-blue-900/50 to-transparent"></div>

         <div className="absolute inset-0 flex flex-col items-center justify-start pt-20 px-6 text-center text-white z-10">
            <motion.div 
                initial={{ opacity: 0, y: -20 }} 
                animate={{ opacity: 1, y: 0 }} 
                transition={{ delay: 0.5, duration: 0.8 }}
                className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/20 mb-5 shadow-sm"
            >
      ...
      <div className="w-full lg:w-1/2 flex flex-col relative z-10">
        ...
        <motion.div 
            ...
            className="flex-1 flex flex-col justify-start lg:justify-center items-center p-6 md:p-12 
                        ...
                        shadow-[0_-15px_60px_-15px_rgba(0,0,0,0.15)] lg:shadow-none 
                        transition-all backdrop-blur-sm lg:backdrop-blur-none"
        >
            <div className="w-full max-w-md space-y-8">
                ...
                <motion.div variants={isMobile ? mobileItemVariant : {}} className="text-center">
