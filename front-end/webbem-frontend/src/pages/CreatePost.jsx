        ...
        <div className="p-4 md:p-6 bg-gray-50 min-h-screen flex justify-center pb-20 font-sans">
            <div className="w-full max-w-4xl">
                ...
                <div className="flex items-center gap-3 md:gap-4 mb-5 md:mb-6">
                    ...
                    <h1 className="text-xl md:text-2xl font-black text-gray-800 tracking-tight">Tulis Berita Baru</h1>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-200 p-5 md:p-8 space-y-6 md:space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wider text-[11px]">Gambar Sampul <span className="text-red-500">*</span></label>
...
`}</style>
                        ...
                        <ReactQuill
                            ...
                            modules={{
                                toolbar: [
                                    [{ 'header': [2, false] }], // Cukup H2 untuk sub-judul di dalam artikel
